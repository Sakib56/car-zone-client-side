...
const AddToys = () => {
    ...
    return (
        <div className='max-w-6xl mx-auto my-20'>
            <h1 className='mx-auto text-center py-3 font-semibold text-white text-3xl  bg-secondary w-1/2'>Add New Toys</h1>
            <Link to="/">
            ...
            <div className='shadow-xl bg-slate-200 pt-5 px-10'>
                ...
                <form onSubmit={handleAddChocolate} className='p-5 '>
                    ...
                    <div className='text-center mt-10'>
                        <button className='bg-secondary rounded-lg px-5 py-3 -lg text-white font-bold text-lg'><input type="submit" value="Add Chocolate" /></button>
                    </div>
                </form>
            </div>
        </div>
